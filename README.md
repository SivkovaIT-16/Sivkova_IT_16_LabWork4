...
Класс Validator содержит слдеующие методы:
...
2. Демонстрация класса Number3_1
   ...
   - Автоматическое преобразование: В конструкторе происходит вызов Function3_1.applyFunction();
   - Вывод результата: Отображение исходных строк и результирующего списка модулей чисел.
3. Демонстрация класса IntegerMas3_1
   ...
   - Автоматическое преобразование: В конструкторе происходит вызов Function3_1.applyFunction();
   - Вывод результата: Отображение исходных массиво и найденных максимумов.
