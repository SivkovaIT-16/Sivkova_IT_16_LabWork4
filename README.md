...
2. Введите номер дейсвия:
 ...
 - 3.Найти максимальное значение.
- 2
3. Введите число, которое необходимо добавить в созданную коробку: -872
...
4. Введите номер дейсвия:
 ...
 - 3.Найти максимальное значение.
- 2
5. Введите число, которое необходимо добавить в созданную коробку: 412.029
...
7. Введите номер дейсвия:
 ...
 - 3.Найти максимальное значение.
- 2
8. Введите число, которое необходимо добавить в созданную коробку: 243
- Коробка со значением 243.0 создана.
9. Введите номер дейсвия:
 - 0.Завершить программу поиска максимума.
 - 1.Просмотр текущих коробок.
 - 2.Создать коробку с числом.
 - 3.Найти максимальное значение.
